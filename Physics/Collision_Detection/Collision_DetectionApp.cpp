...
bool Collision_DetectionApp::startup() {
	...
	//m_sphere1 = new Sphere(glm::vec2(-50, 30), glm::vec2(0, 0), 1.0f, 5.0f, 5.0f, 0.f, 0, 5.0f, 2.0f, 1.f, glm::vec4(1, 1, 0, 0));
	//m_sphere2 = new Sphere(glm::vec2(-30, 10), glm::vec2(0, 0), 2.0f, 2.0f, 5.0f, 0.f, 0, 3.0f, 5.0f, 1.f, glm::vec4(1, 0, 1, 0));
	//m_sphere3 = new Sphere(glm::vec2(0, -20), glm::vec2(0, 0), 1.0f, 5.0f, 5.0f, 0.f, 0, 5.0f, 2.0f, 1.f, glm::vec4(0, 0, 1, 1));
	//m_sphere4 = new Sphere(glm::vec2(0, 20), glm::vec2(0, 0), 1.0f, 1.0f, 5.0f, 0.f, 0, 5.0f, 2.0f, 1.f, glm::vec4(1, 0, 1, 1));

	m_aabb = new AABB(glm::vec2(4, 4), glm::vec2(-60, 20), glm::vec2(0, -40), 5.0f, 0.0f, 0.9f, 0.5f, 0.0f, 0.0f, 0, glm::vec4(1,0,0,1));
	...
	/*m_sphere1->applyForce(glm::vec2(50, 0), glm::vec2(50, 0));
	m_sphere2->applyForce(glm::vec2(0, 50), glm::vec2(0, 40));
	m_sphere3->applyForce(glm::vec2(0, 0), glm::vec2(0, 0));
	m_sphere4->applyForce(glm::vec2(5, 0), glm::vec2(0, 5));*/
	m_aabb->applyForce(glm::vec2(0, -15), glm::vec2(4, 4));
